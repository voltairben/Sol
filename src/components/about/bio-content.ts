...
export const BIO_EN: Bio = {
  ...
  blocks: [
    {
      kicker: "origin",
      body: "I started experimenting with DJ equipment about ten years ago. What began as curiosity slowly became craft — a name, a record collection, and an ear for the music, built one weekend at a time. My first booking came a couple of years later, and it stuck: over the following years I played clubs and events across the south of the Netherlands.",
    },
    {
      kicker: "the pivot",
      body: "I loved the rooms and the crowds, but touring asked more of my personal life than I wanted to give, so I stepped back from the circuit — without stepping away from the music. In 2024 I met TMOCS, who pulled me into two things at once: livestreaming and playing vinyl. Both clicked immediately. I launched my own stream that same year and haven't looked back — the community, the energy, the feeling of a room that never closes.",
    },
    {
...
export const BIO_NL: Bio = {
  ...
  blocks: [
    {
      kicker: "oorsprong",
      body: "Zo'n tien jaar geleden begon ik te experimenteren met dj-apparatuur. Wat als nieuwsgierigheid begon, werd langzaam vakmanschap — een naam, een platencollectie en een oor voor de muziek, weekend na weekend opgebouwd. Mijn eerste boeking kwam een paar jaar later, en het bleef: in de jaren daarna speelde ik in clubs en op events door heel Zuid-Nederland.",
    },
    {
      kicker: "de ommekeer",
      body: "Ik hield van de zalen en het publiek, maar het reizen vroeg meer van mijn privéleven dan ik wilde geven, dus stapte ik uit het circuit — zonder de muziek los te laten. In 2024 leerde ik TMOCS kennen, die me in één klap twee dingen liet ontdekken: livestreamen en vinyl draaien. Allebei voelde meteen goed. Datzelfde jaar startte ik mijn eigen stream, en ik heb geen moment achteromgekeken — de community, de energie, het gevoel van een zaal die nooit sluit.",
    },
    {
